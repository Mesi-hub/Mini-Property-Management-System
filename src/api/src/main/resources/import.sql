...
INSERT INTO property (no_of_bathrooms, no_of_bedrooms, price, area, plot_size, status, description,address_id, owner_id) VALUES (1, 2, 265000, 1250, 6500.5, 'PENDING','A masterpiece. With stunning views.', 5, 2);
INSERT INTO property (no_of_bathrooms, no_of_bedrooms, price, area, plot_size, status, description,address_id, owner_id) VALUES (3, 4, 755000, 2550, 10500.5, 'AVAILABLE', 'The luxury at its best',6, 2);
INSERT INTO property (no_of_bathrooms, no_of_bedrooms, price, area, plot_size, status, description,address_id, owner_id) VALUES (1, 1, 125800, 750, 2500.0, 'AVAILABLE', 'Small family heaven.',7, 4);
